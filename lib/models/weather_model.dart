...
class weatherModel {
  ...
  weatherModel(
      {required this.temp, required this.minTemp, required this.date, required this.maxTem, required this.weatherStateName});

  factory weatherModel.fromJson(dynamic data){
    var jsonData = data['forecast']['forecastday'][0]['day'];
    print('$jsonData');
    return weatherModel(temp: jsonData['avgtemp_c'],
